...
class SettingsRepository(private val context: Context) {
    private object Keys { val ONBOARDED = booleanPreferencesKey("onboarded"); val PLAN = stringPreferencesKey("plan"); val THEME = stringPreferencesKey("theme"); val COMPRESSION = stringPreferencesKey("compression") }
