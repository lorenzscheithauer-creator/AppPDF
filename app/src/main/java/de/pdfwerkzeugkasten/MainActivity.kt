...
@Composable private fun ToolRow(tool: ToolUi, onClick: () -> Unit) {
    ElevatedCard(onClick = onClick, shape = RoundedCornerShape(24.dp), modifier = Modifier.fillMaxWidth()) {
        Row(Modifier.fillMaxWidth().padding(16.dp), verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(14.dp)) {
            ...
            if (tool.isComingSoon) AssistChip(onClick = {}, label = { Text(stringResource(R.string.badge_coming_soon)) })
...
@Composable private fun localizedTools(): List<ToolUi> = listOf(
    ...
    ToolUi(ToolType.PDF_TO_IMAGES, stringResource(R.string.tool_pdf_images_title), stringResource(R.string.tool_pdf_images_desc), stringResource(R.string.tool_pdf_images_keywords), isComingSoon = true),
    ...
    ToolUi(ToolType.PREVIEW, stringResource(R.string.tool_preview_title), stringResource(R.string.tool_preview_desc), stringResource(R.string.tool_preview_keywords), isComingSoon = true)
)
private data class ToolUi(val type: ToolType, val title: String, val description: String, val keywords: String, val isComingSoon: Boolean = false) { val search = SearchableToolText(type, title, description, keywords) }
...
@Composable private fun messageText(message: UiMessage): String = when (message) { UiMessage.NoFile -> stringResource(R.string.error_no_file); UiMessage.UnreadablePdf -> stringResource(R.string.error_unreadable_pdf); UiMessage.ToolRoadmap -> stringResource(R.string.error_tool_roadmap); UiMessage.Processing -> stringResource(R.string.workflow_processing); UiMessage.Done -> stringResource(R.string.result_title); UiMessage.FilesSelected -> stringResource(R.string.workflow_selected_files) }
